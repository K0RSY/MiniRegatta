...
public class Transition extends SceneTemplate {
    ...
    public Transition(SceneTemplate newScene) {
        ...
        Main.getSpeaker().addSoundToQueue("/resources/sounds/transition.wav");
    ...
    public void addTransition(LinkedHashMap<String, ArrayList<ObjectTemplate>> objects) {
        ...
        objects.get("transition").add(new miniregatta.scenes.objects.Transition("/resources/textures/transition.png"));
    }
